...
/*
 * description: A Signal for x,y components of joystick
 * indriver: default
 * name: so_joystick
 * onDataError: 0
...
static const SC_JOYSTICK_cfg_t SO_JOYSTICK_cfg = 
{
   ...
   /* onUpdate           */  ev_on_joystick_update,
   /* onError            */  0,
...
/* signal configuration */
/*
 * description: A Signal having speed data
 * indriver: 0
 * name: so_speed
 * onDataError: 0
...
/* signal configuration */
/*
 * description: A Signal for speed data to engine
 * indriver: 0
 * name: so_engine
 * onDataError: 0
 * onDataUpdate: 0
...
/* signal configuration */
/*
 * description: A Signal for speed data to brakelight
 * indriver: 0
 * name: so_brakelight
 * onDataError: 0
 * onDataUpdate: 0
