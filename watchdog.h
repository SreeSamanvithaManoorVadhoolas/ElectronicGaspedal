...
#define joystick_run 0x00u
#define control_run 0x01u
#define engine_run 0x02u
#define brakelight_run 0x03u
...
/*****************************************************************************/
 ...
 enum WDT_TimeOut{
  ticks_4_6ms       = CYWDT_2_TICKS,    /**< 4 - 6ms. */
  ticks_32_48ms     = CYWDT_16_TICKS,   /**< 32 - 48ms. */
  ticks_256_384ms   = CYWDT_128_TICKS,  /**< 256 - 384ms. */
  ticks_2_3s        = CYWDT_1024_TICKS  /**< 2.048 - 3.072s. */
} ;
